        ...
        {/* TODO
          ...
          */}
          ...
          <TextInput
            ...
            placeholder="holla please"
            onChangeText={(text) => this.setState({inputText})}
        ...
        <View style={styles.messageContainer}>
          ...
          {/* TODO
            ...
            */}
            ...
            <TouchableOpacity style={styles.revealer} onPress={this.toggleDisplay.bind(this)}>
              {!this.state.revealed && (<Text style={styles.revealerText}>Reveal the message!</Text>)}

              {this.state.revealed &&
                (
                  <Text style={styles.revealerText}/>   
                )
              }
            </TouchableOpacity>
